    ...
    <form onSubmit={handleSubmit} className="relative p-4 bg-white border-t border-neutral-200/60">
      <div className="relative max-w-4xl mx-auto">
        ...
        <button
          ...
          className="absolute right-3 bottom-3 inline-flex items-center gap-1.5 pl-3 pr-3.5 py-2 rounded-lg text-sm font-medium transition-all hover:bg-blue-50 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent group"
        >
          ...
          <span className={isLoading || !input?.trim() ? 'text-neutral-300' : 'text-blue-600'}>
